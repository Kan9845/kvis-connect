          ...
          <div className="grid grid-cols-[120px_1fr] sm:grid-cols-[160px_1fr] md:grid-cols-[200px_1fr] gap-6 md:gap-10 items-start">
            ...
            <div className="relative aspect-square overflow-hidden bg-muted">
              ...
              {user.country && (
                <Badge
                  variant="secondary"
                  className="absolute bottom-1.5 right-1.5 rounded-none border-transparent bg-background/90 px-1.5 py-0.5 text-[10px] font-bold uppercase tracking-[0.18em] text-foreground hover:bg-background/90"
                >
