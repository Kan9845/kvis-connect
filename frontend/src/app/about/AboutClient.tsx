    ...
    <PageEntrance>
      ...
      >
        <div className="mx-auto max-w-5xl px-6 lg:px-10">
          ...
          <FadeUp>
            <section className="py-16 grid md:grid-cols-[5fr_3fr] gap-16">
              <div>
                ...
                >
                  <p>
                    ...
                    Education Foundation, Kamnoetvidya Science Academy - KVIS - is
                    Thailand&apos;s first fully residential science high school built
                    to identify and nurture the country&apos;s most gifted students in
                    science and mathematics.
                  </p>
                  <p>
                    The campus sits in the Eastern Science City in Rayong, designed
                    from the ground up for hands-on research. Every admitted student
                    receives a full scholarship: tuition, housing, and meals for the
                    entire three-year program. Admission is intensely competitive -
                    fewer than 72 students are selected from the national pool each
                    year.
                  </p>
                  <p>
                    Graduates have gone on to institutions including MIT, Caltech, ETH
                    Zürich, and Oxford, returning expertise to Thailand&apos;s science
                    and technology landscape. The alumni community is small, global,
                    and tightly connected - qualities that KVIS Connect is built to
                    sustain.
                  </p>
                </div>
              </div>
              ...
              <div className="md:pt-14">
                <StaggerList>
                  {SCHOOL_FACTS.map(({ label, value }) => (
                    <StaggerItem key={label}>
                      <li className="py-4 flex flex-col gap-0.5 border-b border-[var(--kvis-rule)] list-none">
                        <span
                        ...
                        <span className="text-sm font-semibold text-[var(--kvis-ink)]">{value}</span>
                      </li>
                    </StaggerItem>
                  ))}
                </StaggerList>
          ...
          {/* Platform mission */}
          <FadeUp>
            <section className="py-16 grid md:grid-cols-[2fr_3fr] gap-14 items-start">
              <div>
                <p
              ...
              <div
                className="text-sm font-medium space-y-4 md:pt-14 text-[var(--kvis-text2)]"
                style={{ lineHeight: 1.85 }}
              >
                <p>
                  KVIS alumni scatter globally - to research labs, universities,
                  startups, and institutions across dozens of countries. KVIS
                  Connect exists to keep that dispersed community visible to itself:
                  who&apos;s where, what they&apos;re working on, how to reach each
                  other.
                </p>
                <p>
                  The platform is built and maintained by KVIS students and alumni.
                  It is not an official KVIS school product. Everything here - the
                  globe, the directory, the blog - is made by the community, for the
                  community.
                </p>
                <p>
          ...
          <FadeUp>
            <section className="py-16">
              ...
              <h2 className="text-lg font-bold mb-10 text-[var(--kvis-ink)]">
                      ...
                      <div>
                        ...
                        >
                          {c.image ? (
                            ...
                            <span className="text-3xl font-black text-[var(--kvis-purple)]">{c.initials}</span>
                          )}
                        </div>
