"""add visibility to blog

Revision ID: e1b032fd2af7
Revises: 5075e62e1883
Create Date: 2026-06-17 20:59:34.190195
...
revision = 'e1b032fd2af7'
down_revision = '5075e62e1883'
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    op.add_column('blog', sa.Column('visibility', sqlmodel.sql.sqltypes.AutoString(), nullable=False, server_default='public'))
    # ### end Alembic commands ###


def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_column('blog', 'visibility')
